...
--- Configuration des Noms des CLASSEURS (DOCUMENTS Google Sheets) ---
...
creds_json,
scopes=['https://www.google.com/search?q=https://www.googleapis.com/auth/spreadsheets']
)
...
if image_url:
    ...
    st.info("[Image d'une croix simple et de lumière] (URL d'image manquante. Veuillez remplir la colonne 'URL_Image' dans votre feuille)")
